...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/XLHPrediction/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  library(XLHPrediction)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./XLHPredictionResults"
...
cohortTable <- 'XLHPredictionCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/XLHPrediction")
```
