...
OhdsiRTools::checkUsagePackage("XLHPrediction")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/XLHPrediction.pdf")
shell("R CMD Rd2pdf ./ --output=extras/XLHPrediction.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("XLHPrediction")
